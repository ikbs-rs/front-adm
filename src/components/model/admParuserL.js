        ...
        <div className="card">
            ...
            >
                <Column
                    ...
                    style={{ minWidth: '4rem' }}
                />
                <Column field="cpar" header={translations[selectedLanguage].Code} sortable filter style={{ width: '20%' }}></Column>
                <Column field="npar" header={translations[selectedLanguage].Text} sortable filter style={{ width: '60%' }}></Column>
